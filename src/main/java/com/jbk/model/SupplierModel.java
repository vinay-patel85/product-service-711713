...
public class SupplierModel {
	...
	@Min(value = 1,message = "In valid Supplier Id")
	private long supplierId;
	
	@NotBlank(message = "Supplier Name Should Not be Blank")
	@Pattern(regexp = "^[a-zA-Z ]+$",message = "Supplier Name should only contain alphabets and space")
	private String supplierName;
	
	@NotBlank(message = "City Name Should Not be Blank")
	@Pattern(regexp = "^[a-zA-Z ]+$",message = "City Name should only contain alphabets and space")
	private String city;
	...
	@Pattern(regexp = "^[1-9][0-9]{9}$",message = "Mobile number only contian digits, Not start with 0,and be 10 digits")
